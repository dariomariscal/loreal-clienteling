...
/**
 * Report 5 — Top Franquicias / Marcas / Categorías for the Area Manager.
 *
 *   ReportShell
 *     ├─ KpiStrip (resumen: # franquicias, # tiendas, mejor franquicia)
 *     ├─ HorizontalBarChart "Top Franquicias" (banners)
 *     ├─ HorizontalBarChart "Top Marcas" (brands)
 *     └─ Treemap "Ventas por categoría"
 */
    ...
    >
      <KpiStrip columns={3}>
        <KpiCard
          ...
          helper={
            topBanner
              ? `${formatMoney(topBanner.sales.totalAmount)}`
              : undefined
          }
        />
        <KpiCard
