...
/**
 * Report 1 — Executive dashboard for the Area Manager. Same shape as the
 * Counter Manager version, but the scope is the zone — overview metrics come
 * from `useZoneOverview` and the target hero aggregates every counter in the
 * area (sum of attainments).
 */
export function AreaDashboardReport() {
